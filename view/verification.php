<?php
require_once 'C:/xamppp/htdocs /projet_sarra/Model/Quiz.php';  // Inclure le modèle Quiz
require_once 'C:/xamppp/htdocs /projet_sarra/Controller/QuizController.php'; // Inclure le contrôleur QuizController
