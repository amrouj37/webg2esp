...
<?php
  include 'C:/xamppp/htdocs/projet_sarra/Controller/afficher_quiz.php';
  ?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="col-lg-4">
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item">
                ...
                <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#quizModal">QUIZ</a>
            </li>
    ...
    <style>
       ...
       .highlight {
        ...
        #quiz-container {
            ...
            <!-- Quiz Nutrition Modal -->
    <div class="modal fade" id="quizModal" tabindex="-1" aria-labelledby="quizModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
              <div class="modal-header">
                  <h1 class="modal-title" id="quizModalLabel"><b>Quiz Nutrition</b></h1>
              ...
              <div class="modal-body">
                  <form id="quizForm">
                      ...
                      <div class="mb-3">
                          <label for="activityLevel" class="form-label">Niveau d'activité :</label>
                      ...
                      <div class="mb-3">
                          <label for="goal" class="form-label">But :</label>
                          <select id="goal" name="goal" class="form-select" required>
                              <option value="Augmenter le poids">Augmenter le poids</option>
                              <option value="Diminuer le poids">Diminuer le poids</option>
                          </select>
                      </div>
                      <button type="button" id="btnChoisirpack" class="btn btn-primary">Choisir pack</button>
                    </form>
                </section>
                </div>
              </div>
    ...
    <section class="py-5 overflow-hidden">
      <div class="container-lg">
        ...
        <div class="row">
          <div class="col-md-12">
             <!-- Section Packs -->
             <section id="packs" class="packs-container" style="margin-top: 100px; display: none;">
              <h2>Suggestions des Packs</h2>
              <div class="swiper-wrapper">
                  <div class="pack">
                      <img src="images/product-thumb-1.jpg" alt="Pack 1" style="width: 150px; height: auto; object-fit: cover;">
                      <p>Pack  Légumes          </p>
                  </div>
                  <div class="pack">
                      <img src="images/product-thumb-2.jpg" alt="Pack 2" style="width: 150px; height: auto; object-fit: cover;">
                      <p>Pack Fruits et Légumes       </p>
                  </div>
                  <div class="pack">
                      <img src="images/product-thumb-3.jpg" alt="Pack 3" style="width: 150px; height: auto; object-fit: cover;">
                      <p>Pack Produits Laitiers        </p>
                  </div>
                  <div class="pack">
                    <img src="images/product-thumb-4.jpg" alt="Pack 4" style="width: 150px; height: auto; object-fit: cover;">
                    <p>Pack Viandes       </p>
                </div>
                <div class="pack">
                  <img src="images/product-thumb-5.jpg" alt="Pack 5" style="width: 150px; height: auto; object-fit: cover;" >
                  <p>Pack Viandes </p>
              </div>
              </div>
          </section>
          ...
          <!-- Script JavaScript -->
          <script>
              // Écouteur sur le bouton "choisir pack"
              document.getElementById("btnChoisirpack").addEventListener("click", function () {
                  // Sélectionner la section des packs
                  const packSection = document.getElementById("packs");
      
                  // Si la section des packs existe
                  if (packSection) {
                      // Afficher la section
                      packSection.style.display = "block";

      
                      // Supprimer la surbrillance après 1 seconde
                      setTimeout(() => {
                          packSection.classList.remove("highlight");
                      }, 1000);
      
                      // Déplacer automatiquement vers la section des packs
                      packSection.scrollIntoView({ behavior: "smooth" });
                  } else {
                      console.error("Section des packs introuvable !");
                  }
              });
          </script>
          </div>
