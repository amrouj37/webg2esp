...
// Check if `id_recette` is passed in the URL
if (isset($_GET['id'])) {
    $idRecette = $_GET['id'];

    // Fetch the recette details to populate the form
                  ...
                  <form method="POST" action="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="nombre_ing" 
                             value="<?= htmlspecialchars($recette['nombre_ing'] ?? '') ?>" required>
                    </div>
                    <div class="form-group">
                      <label>Instructions Recette</label>
                      <textarea class="form-control" name="instructions_recette" rows="4" required>
                        <?= htmlspecialchars($recette['instructions_recette'] ?? '') ?>
                      </textarea>
                    </div>
                    <div class="form-group">
