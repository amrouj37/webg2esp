        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Create Commande</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="../create_commande.php" method="POST">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="adresse_facturation" id="adresse_facturation" class="form-control" required>
                      </div>
                      <button type="submit" class="btn btn-success">Add Commande</button>
