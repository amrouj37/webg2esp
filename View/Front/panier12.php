                ...
                if (empty($panier)) {
                  ...
                  foreach ($panier as $item): ?>
                    <div class="cart-item mb-3">
                      <p><?php echo $item['produit']; ?> (x<?php echo $item['quantite']; ?>)</p>
                      <form class="d-flex flex-column align-items-center" action="#" method="post">
                        <input type="hidden" name="id" value="<?php echo $item['id']; ?>">
                        <input type="number" name="quantite" value="<?php echo $item['quantite']; ?>" min="1" class="form-control mb-2" style="width: 100px;">
                        <br>
                      </form>
                      <form class="d-flex flex-column align-items-center" action="http://localhost/projet_adam_final/View/Front/remove_from_cart.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $item['id']; ?>">
                        <br>
                  ...
                  <form class="mt-4" action="../Front/checkout12.php" method="get">
