...
require_once 'C:\xampp\htdocs\projet_adam_final\View\Front\index.php';
...
<html lang="en">
  <head>
    <title>SAHA PREP MAIN PAGE</title>
    <meta charset="utf-8">
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
            <div class="d-flex align-items-center my-3 my-sm-0">
              <a href="index.html">
                <img src="..\Front\images\logo.png"  width="150" height="150" alt="logo" class="img-fluid">
              </a>
            </div>
          ...
          <div class="col-lg-4">
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li>
                <a href="formuser.php" class="p-2 mx-1">
          ...
          <div class="col-sm-6 col-lg-2 d-flex gap-4 align-items-center justify-content-center justify-content-sm-end">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4" data-rating="<?= $average_rating ?>" data-price="<?= $plat['prix_plat'] ?>">
                <div class="card h-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <!-- Average Rating and Latest Rating -->
                        ...
                        <form action="index.php" method="POST" class="rating-form">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="rating" value="" /> <!-- Rating value will be inserted here -->
                            </div>
