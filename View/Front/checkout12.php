        ...
        <div class="col-md-12">
          ...
          <div class="section-header d-flex justify-content-between my-4">
            ...
            <div class="container d-flex justify-content-center align-items-center min-vh-100">
              ...
              <form action="../process_checkout.php" method="post" onsubmit="return validateAndSend();">
    <div class="mb-3">
        <label for="adresse_livraison" class="form-label">Delivery Address:</label>
        <input type="text" id="adresse_livraison" name="adresse_livraison" class="form-control form-control-lg">
    </div>

    <div class="mb-3">
        <label for="adresse_facturation" class="form-label">Billing Address:</label>
        <input type="text" id="adresse_facturation" name="adresse_facturation" class="form-control form-control-lg">
    </div>
