<?php
session_start();
require_once 'C:\xampp\htdocs\projet_adam_final\config.php'; // Inclure la configuration pour la connexion à la base de données
...
require_once 'C:/xampp/htdocs/projet_adam_final/View/front/getAverageRating.php';
require_once 'C:/xampp/htdocs/projet_adam_final/view/front/displayRatingInfo.php';
require_once 'C:/xampp/htdocs/projet_adam_final/view/front/getLatestRating.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['rating']) && isset($_POST['id_plat'])) {
    $rating = (int)$_POST['rating']; // Make sure this gets the correct rating
      ...
      <div class="offcanvas-body">
        ...
        <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
          <li class="nav-item border-dashed active">
            <a href="client.php"nav-link d-flex align-items-center gap-3 text-dark p-2">
          ...
          <li class="nav-item border-dashed">
            ...
            <div class="collapse" id="beverages-collapse">
              <ul class="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
                <li class="border-bottom py-2"><a href="client.php"dropdown-item">Water</a></li>
                <li class="border-bottom py-2"><a href="client.php"dropdown-item">Juice</a></li>
                <li class="border-bottom py-2"><a href="client.php"dropdown-item">Soda</a></li>
                <li class="border-bottom py-2"><a href="client.php"dropdown-item">Tea</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item border-dashed">
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-5 col-lg-1 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
            <div class="d-flex align-items-center my-3 my-sm-0">
              <a href="index.php">
              <img src="..\Front\images\logo.png"  width="150" height="150" alt="logo" class="img-fluid">              </a>
            </div>
          ...
          <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-4">
            <div class="search-bar row bg-light p-2 rounded-4">
              ...
              <div class="col-11 col-md-7">
                <form id="search-form" class="text-center" action="client.phpmethod="post">
          ...
          <div class="col-lg-7">
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              <li class="nav-item active">
                <a href="client.php" class="nav-link">Home</a>
              </li>
          ...
          <li class="nav-item dropdown">
              ...
              <li class="nav-item">
                <!-- Trigger the modal with the QUIZ link -->
                <a href="ajout.php" class="nav-link" >QUIZ</a>
            </li>
      ...
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-primary">Healthy</span> Tunisian meals at your <span class="fw-bold">Doorsteps</span></h2>
            <p class="fs-4">Eat like the GOAT.</p>
            <div class="d-flex gap-3">
            <a href="select_pack.php" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">voir votre pack</a>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">fresh meals</h5>
                    <p class="card-text">with fresh ingredients from local tunisian farmers.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    ...
                    <p class="card-text">fresh ingredients with no pestisides or chemicals used.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    ...
                    <p class="card-text">we will deliver to you to all places in tunisia .</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="container d-flex justify-content-center align-items-center min-vh-100">
                    <div class="section-header text-center">
                        <h1>Plats</h1>
                        <div id="platsContainer" class="d-flex flex-wrap justify-content-center">
                            <?php 
                            require_once 'C:/xampp/htdocs/projet_adam_final/Controller/platcontroller.php';
                            require_once 'C:/xampp/htdocs/projet_adam_final/Controller/recettecontroller.php';
                            require_once 'C:/xampp/htdocs/projet_adam_final/Controller/ratingcontroller.php';
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 mb-4" data-rating="<?= $average_rating ?>" data-price="<?= $plat['prix_plat'] ?>">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <!-- Ratings -->
                                        <p class="rating-info">Average Rating: <?= $average_rating ?> / 5</p>
                                        <p class="rating-info">Latest Rating: <?= $latest_rating ?> / 5</p>

                                        <!-- Star Rating -->
                                        <form action="client.php" method="POST" class="rating-form">
                                            ...
                                            <button type="submit" class="btn btn-primary" disabled>Submit Rating</button>
                                        </form>

                                        <!-- Add to Cart Form -->
                                        <form action="addToCart.php" method="POST">
                                            <input type="hidden" name="produit" value="<?= htmlspecialchars($plat['nom_plat']); ?>" />
                        ...
                        <br>
                        <form action="panier12.php" class="text-center">
...
<div class="container">
  <div class="section-header d-flex flex-wrap justify-content-between my-4">
    ...
    <div class="d-flex align-items-center">
      <form method="POST" action="client.php"mb-0">
  ...
  <form method="POST" action="client.php"d-flex justify-content-center">
    <input 
      type="text" 
      id="ingredient-input" 
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <div class="card-body text-center">
            ...
            <!-- Safely pass the recipe data to JavaScript -->
            <button type="button" class="btn btn-primary" 
                    onclick="saveRecetteAsTxt({
                        name: '<?= addslashes($recette['nom_recette']); ?>', 
                        instructions_recette: '<?= addslashes($recette['instructions_recette']); ?>', 
                        nombre_ing: '<?= addslashes($recette['nombre_ing']); ?>'
                    })">Save Recette</button>
          </div>
        </div>
      </div>
  ...
  <?php endif; ?>
            ...
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                ...
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">top 5 meals for your diet</a>
                  </h3>
                  <p>our 5 best meals on the site</p>
                </div>
              </div>
            </article>
          </div>
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                ...
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">high protein meal options</a>
                  </h3>
                  <p>foods rich in protein that aid in muscle building</p>
                </div>
              </div>
            </article>
          </div>
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              ...
              <div class="card-body">
                ...
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">vegetarian meal options</a>
                  </h3>
                  <p>foods rich in fiber and low cal for our veggie lovers</p>
                </div>
              </div>
            </article>
          </div>
    ...
    <section class="py-4">
      <div class="container-lg">
        ...
        <a href="#" class="btn btn-warning me-2 mb-2">loubya</a>
        <a href="#" class="btn btn-warning me-2 mb-2">kamouneya</a>
        <a href="#" class="btn btn-warning me-2 mb-2">tajin</a>
        <a href="#" class="btn btn-warning me-2 mb-2">brick</a>
        <a href="#" class="btn btn-warning me-2 mb-2">kefta</a>
        <a href="#" class="btn btn-warning me-2 mb-2">makloub escalope</a>
        <a href="#" class="btn btn-warning me-2 mb-2">pizza</a>
        <a href="#" class="btn btn-warning me-2 mb-2">mexican tacos</a>
        <a href="#" class="btn btn-warning me-2 mb-2">slata mechouia</a>
        <a href="#" class="btn btn-warning me-2 mb-2">rouz jerbi</a>
        <a href="#" class="btn btn-warning me-2 mb-2">air fried fricasse</a>
        <a href="#" class="btn btn-warning me-2 mb-2">air fried kafteji</a>
      </div>
    </section>
        ...
        <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-5">
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                <h5>Free delivery</h5>
                <p class="card-text">to all of tunisia.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">you dont have to worry about your hard earned cash.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">the best of the best ingredients sourced from local farms.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">deals all throughout the week.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                <h5>Daily offers</h5>
                <p class="card-text">get a bang for ur buck.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            ...
            <img src="..\Front\images\logo.png"  width="150" height="150" alt="logo" class="img-fluid">              <div class="social-links mt-3">
