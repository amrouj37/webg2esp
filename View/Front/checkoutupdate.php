      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-header d-flex justify-content-between my-4">
            ...
            <h2 class="section-title text-center my-4">Checkout</h2>
            <?php
            ...
            if (isset($_GET['id'])) {
              ...
              // Fetch current data for the order
            ...
            <h2 class="section-title text-center my-4">Modifier Commande</h2>
            <div class="container d-flex justify-content-center align-items-center min-vh-100">
              <div id="cart" class="text-center">
                <form action="../update_commande.php" method="post">
                  <!-- Hidden input to pass the id_commande -->
                  <input type="hidden" name="id_commande" value="<?= $id_commande ?>">

                  <div class="mb-3">
                    <label for="date_commande" class="form-label">Date Commande:</label>
                    <input type="text" id="date_commande" name="date_commande" class="form-control form-control-lg" value="<?= $date_commande ?>" disabled>
                  </div>

                  <div class="mb-3">
                    <label for="adresse_livraison" class="form-label">Delivery Address:</label>
                    <input type="text" id="adresse_livraison" name="adresse_livraison" class="form-control form-control-lg" value="<?= $adresse_livraison ?>" required>
                  </div>

                  <div class="mb-3">
                    <label for="adresse_facturation" class="form-label">Billing Address:</label>
                    <input type="text" id="adresse_facturation" name="adresse_facturation" class="form-control form-control-lg" value="<?= $adresse_facturation ?>" required>
                  </div>
