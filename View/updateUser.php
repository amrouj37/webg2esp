<?php
include 'C:\xampp\htdocs\projet_adam_final\config.php';
include_once 'C:\xampp\htdocs\projet_adam_final\Model\user.php';
...
<body class="bg-gradient-login">
  ...
  <div class="container-login">
    <div class="row justify-content-center">
      ...
      <?php if ($userToUpdate): ?>
                  <form method="POST" action="index.php?id_user=<?php echo $id_user; ?>">
                    ...
                    <div class="form-group">
                      <button type="submit" class="btn btn-primary btn-block"  onclick="window.location.href='index.php';">update</button>
                    </div>
                    <hr>
