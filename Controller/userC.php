...
require_once 'C:\xampp\htdocs\projet_adam_final\Model\user.php';
class userC{
    ...
    public function addUser($user) {
        $conn = conn::getConnexion(); // Connexion à la base de données
...
public function getUserByEmail($email_user) {
    $conn = conn::getConnexion();  // Utilisation de la classe config pour obtenir la connexion
